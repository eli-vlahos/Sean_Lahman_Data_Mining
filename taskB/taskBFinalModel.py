...
if __name__ == "__main__":
    ...
    clf = DecisionTreeClassifier(max_depth=4, min_samples_split=12, min_samples_leaf=19 ,class_weight="balanced")
    ...
    plt.savefig('../pngs/taskB_finalModel_confMatrix.png')

    tree.export_graphviz(clf, out_file='taskBFinalModel.dot', 
