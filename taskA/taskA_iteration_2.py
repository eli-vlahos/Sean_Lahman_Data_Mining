...
if __name__ == "__main__":
    ...
    # -----------------------------------------------------------------------------------
    # Dropping colunms that are not nominated so that our data set is roughly 50% nominated and 50% not nominated
    df = df.drop(df[df['nominated'] == 0][1300:].index)
    # -----------------------------------------------------------------------------------
    ...
    plt.savefig('../pngs/taskA_iteration2_confMatrix.png')
